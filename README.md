...
- `cases/HHG-001.json` through `cases/HHG-020.json` (20 required answer files, at repository root)
...
IEEE-CIS/Vesta dataset with challenge additions by TigerGraph. See the organizer-provided README for the authoritative benchmark and policy. Regulatory context is attributed in the retrieved policy documents.
